...
struct CardPresets {
    static let all: [CardTemplate] = [
        CardTemplate(name: "Platinum", issuer: "American Express", benefits: [
        ...
        CardTemplate(name: "Gold", issuer: "American Express", benefits: [
        ...
        CardTemplate(name: "Sapphire", issuer: "Chase", benefits: [
