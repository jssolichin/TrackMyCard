...
struct CardPresets {
    static let all: [CardTemplate] = [
        CardTemplate(name: "Platinum", benefits: [
            BenefitTemplate(name: "Hotel Credit", amount: 300, period: .semiAnnually, notes: "FHR/Hotel Collection (prepaid)."),
            ...
            BenefitTemplate(name: "Lululemon Credit", amount: 75, period: .quarterly, notes: "$75 quarterly credit for in-store or online Lululemon purchases."),
            BenefitTemplate(name: "Oura Ring Credit", amount: 200, period: .annually, notes: "One-time annual credit toward Oura Ring purchases."),
            BenefitTemplate(name: "Digital Entertainment", amount: 25, period: .monthly, notes: "Disney+, Hulu, ESPN+, Peacock, NYT, WSJ, YouTube Premium."),
            BenefitTemplate(name: "Uber Cash", amount: 15, period: .monthly, notes: "Rides or Eats. $35 total in Dec."),
            ...
            BenefitTemplate(name: "Saks Fifth Avenue", amount: 50, period: .semiAnnually, notes: "Jan-Jun and Jul-Dec shopping credits."),
            BenefitTemplate(name: "Equinox Credit", amount: 300, period: .annually, notes: "Credit for Equinox membership or Equinox+ app."),
            BenefitTemplate(name: "CLEAR Plus", amount: 209, period: .annually, notes: "Increased to cover the full annual membership cost."),
        ...
        CardTemplate(name: "Business Platinum", benefits: [
            ...
            BenefitTemplate(name: "Indeed Credit", amount: 90, period: .quarterly, notes: "Indeed services."),
            BenefitTemplate(name: "Wireless Credit", amount: 10, period: .monthly, notes: "US wireless services."),
            BenefitTemplate(name: "Airline Fee Credit", amount: 200, period: .annually, notes: "Incidental fees on your selected airline."),
        ...
        CardTemplate(name: "Reserve", benefits: [
            ...
            BenefitTemplate(name: "Exclusive Tables Dining", amount: 150, period: .semiAnnually, notes: "For bookings via Sapphire Exclusive Tables."),
            ...
            BenefitTemplate(name: "Apple TV/Music", amount: 24, period: .monthly, notes: "Credits for Apple TV+ and Apple Music subscriptions."),
        ...
        CardTemplate(name: "Venture X", benefits: [
            ...
            BenefitTemplate(name: "Anniversary Bonus", amount: 100, period: .annually, notes: "10,000 bonus miles every anniversary."),
            BenefitTemplate(name: "Global Entry/TSA PreCheck", amount: 120, period: .everyFourYears, notes: "Statement credit for application fees."),
